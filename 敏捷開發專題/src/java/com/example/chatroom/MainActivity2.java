...
import com.example.chatroom.Fragments.InformationFragment;
import com.example.chatroom.Fragments.UsersFragment;
import com.example.chatroom.Model.User;
import com.example.chatroom.Notifications.MyFirebaseMessaging;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new InformationFragment(),"Info");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.logout:
                ...
                return true;
            case R.id.profile:
                startActivity(new Intent(MainActivity2.this,ProfileActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
            default:
                break;
