        ...
        if (chat.getType().equals("text"))
        {
            ...
            holder.show_message.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    MessageActivity.MessagegClear();
                    MessageActivity.EmojiClear();
...
//                final PopupMenu dropDownMenu = new PopupMenu(mContext, holder.show_image);
...
//                                Intent intent;
//                                intent = new Intent(mContext, Show_Full_Image.class);
...
//                        dropDownMenu.show();
        ...
        DatabaseReference reference3 = FirebaseDatabase.getInstance().getReference("Chats");
