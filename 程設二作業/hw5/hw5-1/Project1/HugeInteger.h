...
bool HugeInteger< T >::operator<( const HugeInteger< T > &right ) const
{
    typename vector< T >::const_iterator it1 = integer.end() - 1;
    typename vector< T >::const_iterator it2 = right.integer.end() - 1;
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger< T > &op2 )
{
   ...
   typename vector< T >::iterator it1 = product.integer.begin();
   typename vector< T >::iterator it2 = integer.begin();
   typename vector< T >::iterator it3 = op2.integer.begin();
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   typename vector< T >::iterator it1 = remainder.integer.end() - 1;
   typename vector< T >::iterator it2 = integer.end() - 1;
   typename vector< T >::iterator it3 = op2.integer.end() - 1;
   typename vector< T >::iterator it5 = buffer.integer.end() - 1;
   ...
   typename vector< T >::iterator it6 = quotient.integer.end() - 1;
